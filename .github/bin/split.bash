...
copy_assets() {
  ...
  ls -las "${PLATFORM_DIR}/src/${package}/Resources/public" || true
  ...
  ls -las "${PLATFORM_DIR}/src/${package}/Resources/app/${package_lower}/dist" || true
  ...
  ls -las "${PLATFORM_DIR}/src/${package}/Resources/app/${package_lower}/vendor" || true
